...
import { EntityArrayResponseType, KioskFormService } from '../service/kiosk-form.service';
...
export class KioskFormComponent implements OnInit {
  ...
  delete(kioskForm: IKioskForm): void {
    const modalRef = this.modalService.open(KioskFormDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.kioskForm = kioskForm;
  ...
  protected fillComponentAttributesFromResponseBody(data: IKioskForm[] | null): IKioskForm[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.kioskFormService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
