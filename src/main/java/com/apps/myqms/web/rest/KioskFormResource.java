...
public class KioskFormResource {
    ...
    public ResponseEntity<KioskForm> partialUpdateKioskForm(
        ...
        System.out.println("A new Query has been raised with ID " + kioskForm.getId());
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createAlert(
                applicationName,
                "A new Query has been raised with ID " + kioskForm.getId(),
                String.valueOf(kioskForm.getId())
            )
        );
    }
